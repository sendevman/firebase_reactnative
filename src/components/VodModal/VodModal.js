...
class VodModal extends Component {
  ...
  _onWatchBigScreen() { console.log('Watch On The Big Screen'); this.eventlog('cast');}
...
const mapStateToProps = state => {
  const { current, vod, common } = state;

  return { featured: vod.featured, fullList: vod.fullList, location: current.position, firebaseid: common.firebaseid };
}
