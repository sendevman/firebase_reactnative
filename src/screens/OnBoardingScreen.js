...
//   const { onShowModal, goProduct } = props;
//   return (
//     <View>
//       <View style={[styles.fiftyBox, { alignItems: 'flex-end' }]}>
//         <View style={styles.containerPhone}>
...
//           <TouchableOpacity style={styles.getStartedBtn} onPress={() => { 1 ? goProduct() : onShowModal() }}>
...
class OnBoardingScreen extends Component {
  ...
  render() {
    ...
    return (
      ...
      //     <View style={styles.container}>
      //       <OnBoardingFour onShowModal={this.showModal} goProduct={this.goProduct} />
      //     </View>
      //   </Carousel>
